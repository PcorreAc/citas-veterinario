    ...
    <div className="m-3 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <p className="font-bold mb-3 text-gray-700 uppercase">
        ...
        <span className="font-normal normal-case">
          ...
          et, quas laborum nam a neque aspernatur dignissimos! A praesentium
          fugiat corporis, consectetur quis voluptatibus facilis consequatur
          quas fuga alias ducimus.
        </span>
      </p>
    </div>
  );
